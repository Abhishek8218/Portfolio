...
import Abhishek_Kumar_Resume from "../Abhishek_Kumar _Resume.pdf"
const Home = () => {
      ...
      <div className=" max-w-screen-lg mx-auto flex flex-col items-center justify-center h-fit px-4 md:flex-row py-10">
        <div className="flex flex-col justify-center h-fit pt-20 pb-15 md:mr-8">
          ...
          <p className="mt-4  text-lg text-gray-50 font-para">
            Welcome to my portfolio website! I'm Abhishek, a frontend developer. I'm passionate about creating visually appealing and functional websites using the latest web technologies. Feel free to browse my portfolio and reach out to me with any questions or project inquiries. Thank you for stopping by!
          </p>
